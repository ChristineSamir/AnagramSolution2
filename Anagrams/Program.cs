...
var dictionary = new List<string> { "Listen", "HEART", "Ear", "Silent", "Face", "Earth"," Farm ", "Are ", "Cafe", "Break", "Music",  "  baker", " Brake ", "dinosaur", "Door", "HATER",  "Angel", "Below", "Bowel", "angle", "angels", "elbow" };
